...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            var defaults = {
                clockImagesPath: 'https://github.com/calusos1/clock/blob/master/images/clock/',
                weatherImagesPath: 'https://github.com/calusos1/clock/blob/master/images/weather/',
                lang: 'en',
                am_pm: false,
            ...
            return this.each(function() {
                ...
                html    += '<p id="left_arrow"><img src="https://github.com/calusos1/clock/blob/master/images/icon_left.png?raw=true" /></p>';
                html    += '<p id="right_arrow"><img src="https://github.com/calusos1/clock/blob/master/images/icon_right.png?raw=true" /></p>';
